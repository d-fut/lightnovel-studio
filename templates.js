...
## 字数配分（厳守）
- 総字数：{total_chars}字
- 第一幕分：{act1_chars}字 → この幕を担当する章の合計がこの字数になること
- 第二幕分：{act2_chars}字 → この幕を担当する章の合計がこの字数になること
- 第三幕分：{act3_chars}字 → この幕を担当する章の合計がこの字数になること
- **全章の目安字数の合計が{total_chars}字になること（必須）**

## 章数の目安
- 1章あたり2,000〜3,000字
- 第一幕：{act1_chap_count}章程度
- 第二幕：{act2_chap_count}章程度
- 第三幕：{act3_chap_count}章程度

## 固有名詞リスト
{nouns}

## 出力フォーマット（Markdownのみ・JSONは使わない）
章ごとに以下の構造で出力せよ。幕の区切りに見出しを入れること。
...
---
## 字数合計確認
全章の目安字数の合計：X字（総字数{total_chars}字との差：Y字）
